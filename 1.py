...
\033[1;97m [\033[1;94m✯\033[1;91m] \033[1;92mNOTE : CHROME USER AGENTS ONLY
\033[1;90m═══════════════════════════════════════════════════════════
    """
...
os.system("clear")
print(logo)
print("\033[92;1m[+] USER AGENT SAVED IN -> c-ua.txt")
print("\033[92;1m")
print(b1)
print("")
print(b2)
...
open("c-ua.txt","a").write(b1+'\n')
open("c-ua.txt","a").write(b2+'\n')
open("c-ua.txt","a").write(b3+'\n')
open("c-ua.txt","a").write(b4+'\n')
open("c-ua.txt","a").write(b5+'\n')
