...
\033[1;97m [\033[1;94m✯\033[1;91m] \033[1;92mNOTE : FIREFOX USER AGENTS ONLY
\033[1;90m═══════════════════════════════════════════════════════════
    """
    
x = UserAgent(family='firefox')
b1 =x.random()
b2 = x.random()
b3 = x.random()
b4 = x.random()
...
os.system("clear")
print(logo)
print("\033[92;1m[+] USER AGENT SAVED IN -> f-ua.txt")
print("\033[92;1m")
print(b1)
print("")
print(b2)
...
open("f-ua.txt","a").write(b1+'\n')
open("f-ua.txt","a").write(b2+'\n')
open("f-ua.txt","a").write(b3+'\n')
open("f-ua.txt","a").write(b4+'\n')
open("f-ua.txt","a").write(b5+'\n')
